...
Original file is located at
    https://colab.research.google.com/drive/1LJyBleEcSVD_NurxFWfavgdqQC7GvZlo

Layer 11 classification for each labels - 190569J sarraj sm
"""
...
# Load our dataset
train = pd.read_csv('/content/drive/MyDrive/ML/layer11/train.csv')
test = pd.read_csv('/content/drive/MyDrive/ML/layer11/test.csv')
valid = pd.read_csv('/content/drive/MyDrive/ML/layer11/valid.csv')
...
features_to_drop_1 = [column for column in upper_1.columns if any(upper_1[column] > 0.8)]
...
result_1_df = pd.read_csv('/content/drive/MyDrive/ML/layer11/test_with_predictions.csv')
result_1_df['ID'] = ids
result_1_df['label_1'] = test_pred_label1

result_1_df.to_csv('/content/drive/MyDrive/ML/layer11/test_with_predictions.csv', index=False)
...
features_to_drop_2 = [column for column in upper_2.columns if any(upper_2[column] > 0.9)]
...
result_2_df = pd.read_csv('/content/drive/MyDrive/ML/layer11/test_with_predictions.csv')
result_2_df['label_2'] = test_pred_label2
result_2_df.to_csv('/content/drive/MyDrive/ML/layer11/test_with_predictions.csv', index=False)
# result_1_df['Predicted labels after feature engineering'] = test_pred_label1
# result_1_df['No of new features'] = no_of_components
# new_column_names = [f'new_feature_{i+1}' for i in range(scaled_original_test.shape[1])]
# pca_df = pd.DataFrame(data=scaled_original_test,columns=new_column_names)
...
features_to_drop_3 = [column for column in upper_3.columns if any(upper_3[column] > 0.5)]
...
result_3_df = pd.read_csv('/content/drive/MyDrive/ML/layer11/test_with_predictions.csv')
result_3_df['label_3'] = test_pred_label3
result_3_df.to_csv('/content/drive/MyDrive/ML/layer11/test_with_predictions.csv', index=False)
# result_1_df['Predicted labels after feature engineering'] = test_pred_label1
# result_1_df['No of new features'] = no_of_components
# new_column_names = [f'new_feature_{i+1}' for i in range(scaled_original_test.shape[1])]
# pca_df = pd.DataFrame(data=scaled_original_test,columns=new_column_names)
...
features_to_drop_4 = [column for column in upper_4.columns if any(upper_4[column] > 0.8)]
...
result_4_df = pd.read_csv('/content/drive/MyDrive/ML/layer11/test_with_predictions.csv')
result_4_df['label_4'] = test_pred_label4
result_4_df.to_csv('/content/drive/MyDrive/ML/layer11/test_with_predictions.csv', index=False)
# result_1_df['Predicted labels after feature engineering'] = test_pred_label1
# result_1_df['No of new features'] = no_of_components
# new_column_names = [f'new_feature_{i+1}' for i in range(scaled_original_test.shape[1])]
# pca_df = pd.DataFrame(data=scaled_original_test,columns=new_column_names)
